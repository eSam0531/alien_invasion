...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Creat an alien Group to manage aliens
    ...
    def _update_aliens(self):
        ...
        # Loot for alien-ship collisions.
        if pygame.sprite.spritecollideany(self.ship, self.aliens):
            # used to test collision between ship and aliens
            #print("Ship hit!!!")
            self._ship_hit()
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat this the same as iff the ship got hit.
                self._ship_hit()
                break
